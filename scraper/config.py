...
BATCH_SIZE = 100  # Number of concurrent requests per worker
NUM_WORKERS = 10  # Number of worker sessions to use
CHECKPOINT_SIZE = 1000  # Save results to CSV after this many records
